...
public:
	 ...
	 */
	DrivebaseSimSRX(WPI_TalonSRX& leftMaster, WPI_TalonSRX& rightMaster, WPI_PigeonIMU& pidgey);
...
private:
	...
	TalonSRXSimCollection& _leftMasterSim;
	TalonSRXSimCollection& _rightMasterSim;
	PigeonIMUSimCollection& _pidgeySim;
