...
public:
	...
	WPI_TalonSRX _rghtFront{3};
	WPI_TalonSRX _rghtFollower{2};
	WPI_TalonSRX _leftFront{6};
	WPI_TalonSRX _leftFollower{4};
	...
	DrivebaseSimSRX _driveSim{_leftFront, _rghtFront, _pidgey};
