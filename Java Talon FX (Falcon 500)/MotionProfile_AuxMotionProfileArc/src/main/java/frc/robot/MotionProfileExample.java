 ...
 * Although this code uses a Talon FX, nowhere Set() Called. 
...
public class MotionProfileExample {
	...
	boolean IsMotionProfile(int controlMode) {
		if (controlMode == TalonFXControlMode.MotionProfile.value)
			return true;
		if (controlMode == TalonFXControlMode.MotionProfileArc.value)
			return true;
		return false;
	}
