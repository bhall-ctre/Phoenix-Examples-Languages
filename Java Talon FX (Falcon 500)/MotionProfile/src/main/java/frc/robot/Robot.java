...
public class Robot extends TimedRobot {
	/** Hardware */
	WPI_TalonFX _talon = new WPI_TalonFX(1);	// Talon to Motion Profile
	...
	public void teleopPeriodic() {
		...
		if (btns[5] == false) {
			 ...
			 */
			_talon.set(TalonFXControlMode.PercentOutput, leftYjoystick);
			...
			_talon.set(TalonFXControlMode.MotionProfile, setOutput.value);
